...
@Component({
  ...
  template: `
    <hlm-menu-bar class="min-w-96 px-3 min-h-16 flex-row justify-between">
      ...
      <button hlmMenuBarItem class="min-w-20 flex text-md justify-center h-12" [brnMenuTriggerFor]="edit">Doctor</button>
      <button hlmMenuBarItem class="min-w-20 flex text-md justify-center h-12" [brnMenuTriggerFor]="view">Profile</button>
      <button hlmBtn hlmMenuBarItem class="min-w-20 flex text-md justify-center h-12" [brnMenuTriggerFor]="profiles">Get Doctor</button>
    </hlm-menu-bar>
